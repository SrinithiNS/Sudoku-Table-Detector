...
class BoardExtractor:
    ...
    def detect_and_crop_grid(self):
        ...
        def drawLine(line, img):
            ...
            if line[0][1] != 0:
                ...
                cv2.line(img, (int(line[0][0]), 0), (int(line[0][0]), height), (255,255,255),1)
            return img
            ...
            for current in lines:
                ...
                for pos in lines:
                    if pos[0].all() == current[0].all():
                        continue
                    if (pt1current[0] < 10 or pt1current[0] > width - 10 or pt1current[1] < 10 or pt1current[1] > height - 10) or (pt2current[0] < 10 or pt2current[0] > width - 10 or pt2current[1] < 10 or pt2current[1] > height - 10):
                        continue
    ...
    def create_image_grid(self):
        ...
        grid = cv2.bitwise_not(cv2.adaptiveThreshold(grid, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 81, 1))
