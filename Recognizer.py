'''This class takes an input paramater modeltype.This class also preprocesses the grid cell
...
class DigitRecognizer:
    ...
    '''This function initializes a CNN based on the input parameter modeltype'''
    def __init__(self, modeltype):
        ...
        if modeltype == "CNN":
            try:
                self.model = keras.models.load_model("cnn.hdf5")
            except Exception as e:
                raise Exception("cnn.hdf5 not found!")

    '''This function takes a preprocessed image and
    returns the prediction made on the image by the CNN'''
